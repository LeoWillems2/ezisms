{{-- Gedeelde sub-navigatie voor blok 11 (Auditmanagement). Eén menu-item
     ("Audits") in de zijbalk; het bevindingenregister, het auditprogramma en de
     dekkingsmatrix (plan 11b) zijn van hieruit bereikbaar. --}}
<flux:navbar class="mb-2">
    ...
    <flux:navbar.item :href="route('audits.bevindingen')" :current="request()->routeIs('audits.bevindingen')" wire:navigate>
        Bevindingen
    </flux:navbar.item>
