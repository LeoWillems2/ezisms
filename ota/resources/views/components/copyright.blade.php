...
<footer class="mt-10 border-t border-zinc-200 pt-4 text-center text-xs text-zinc-500">
    This work is licensed under <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/" class="underline">CC BY-NC-SA 4.0</a>@foreach (['cc', 'by', 'nc', 'sa'] as $icoon)<img src="{{ asset('images/cc/'.$icoon.'.svg') }}" alt="" class="inline" style="max-width: 1em;max-height:1em;margin-left: .2em;">@endforeach
</footer>
